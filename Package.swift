...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/amplitude/analytics-connector-ios.git", exact: "1.3.2"),
        ...
        .package(url: "https://github.com/google/GoogleUtilities.git", exact: "8.1.2"),
        ...
        .package(url: "https://github.com/googlemaps/ios-maps-sdk.git", exact: "11.0.0"),
        ...
        .package(url: "https://github.com/pusher/NWWebSocket.git", exact: "0.5.10"),
        .package(url: "https://github.com/pusher/pusher-websocket-swift.git", exact: "10.1.8"),
        ...
        .package(url: "https://github.com/tus/TUSKit", exact: "3.7.1"),
